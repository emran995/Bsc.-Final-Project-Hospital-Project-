...
//                rd1.setChecked ( false );
    ...
    public void EnterFinsh1(View view) {
        ...
        satisfactionOfPatients  = new SatisfactionOfPatients ( GlobalClass.answer1, GlobalClass.satisfation,GlobalClass.satisfation1);
        ...
        if (count > 0) {
            ...
            builder.setMessage ( "Sorry you can't Continue please Go To the Doctor" );
