...
public PatientsTraining patientsTraining;
   ...
   int [][] myArray1,myArray11,myArray2,myArray22,myArray3,myArray33,myArray4,myArray44,myArray5,myArray55,myArray6,myArray66;
    ...
    int bloodpressure =(Integer.valueOf (GlobalClass.bloodpressureSystolic)+Integer.valueOf (  GlobalClass.bloodpressureDiastolic))/2;


    int [] arr= { Integer.parseInt (GlobalClass.glucose) ,Integer.parseInt (GlobalClass.weight),
            Integer.parseInt (GlobalClass.heartbeat),bloodpressure,
    ...
    @Override    protected void onCreate(Bundle savedInstanceState) {
       ...
       String b1="* Force Rubber Bar -> "+convertD ( ans2 );
    ...
    public void finish23(View view) {
        ...
        patientsTraining= new PatientsTraining (date,GlobalClass.answer1,GlobalClass.firstName,GlobalClass.lastName,GlobalClass.gender1,
                GlobalClass.age,GlobalClass.glucose,GlobalClass.weight,GlobalClass.heartbeat,GlobalClass.bloodpressureSystolic+"/"+GlobalClass.bloodpressureDiastolic,GlobalClass.gettingmedic2,GlobalClass.rislevel2,
        ...
        DatabaseReference Dataa = FirebaseDatabase.getInstance ().getReference ("Data").child ( "Patients Training" );
        Dataa.push ().setValue ( patientsTraining );
