...
public class Main51Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text=findViewById ( R.id.textView67 );
        text2=findViewById ( R.id.textView84 );

        text3=findViewById ( R.id.textView85 );
        ...
        query.addListenerForSingleValueEvent ( new ValueEventListener () {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText ( Main51Activity.this, "Opsss.... Something is wrong", Toast.LENGTH_SHORT ).show ();
            }
        } );
    ...
    public void details500(View view){
        ...
        query.addListenerForSingleValueEvent ( new ValueEventListener () {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren ()) {
                    ...
                    AlertDialog.Builder builder= new AlertDialog.Builder ( Main51Activity.this );
