            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren ()) {
                    ...
                    if (p.getTraining1 ().equals ( "* Force Free Weight -> Yes" )) {
                     ...
                     if (p.getTraining2 ().equals ("* Force Rubber Bar -> Yes" )) {
                        training2++;  }

                    if (p.getTraining3 ().equals ("* Riding Bikes -> Yes")) {
                        training3++;  }

                   if (p.getTraining4 ().equals ( "* Riding Elliptic -> Yes" )) {
                        training4++;  }
                ...
                t2.setText ( "Number of workouts of type Force Rubber Bar: "+String.valueOf ( training2 ) );
                t3.setText ( "Number of workouts of type Riding Elliptic: " +String.valueOf ( training3 ));
                t4.setText ( "Number of workouts of type Riding Bikes: "+String.valueOf ( training4 ) );
