...
public class Main2Activity extends AppCompatActivity {
    ...
    public void enterRegister(View view) {
        ...
        if (TextUtils.isEmpty ( id )&& TextUtils.isEmpty ( password )&&TextUtils.isEmpty ( fullName )&&TextUtils.isEmpty ( birthday1 )
                && TextUtils.isEmpty ( location )&&TextUtils.isEmpty ( phone)  && rd1.isChecked () == false && rd2.isChecked () == false) {
        ...
        if(phone.length ()<7){
            Toast.makeText ( Main2Activity.this, "Your Phone should be at least 7 numbers",
                    Toast.LENGTH_SHORT ).show ();
        ...
        if(first.length ()<2 ){
            ...
            Toast.makeText ( Main2Activity.this, "Enter Your First tName",
                    Toast.LENGTH_SHORT ).show ();
            newFullName.setError ("Enter Your  First Name" );
            return;
        }
